...
* O back-end do projeto foi desenvolvido com a linguagem Java na versão 11.
...
* No front-end foi usado o thymeleaf  que é uma template engine para projetos Java que facilita a criação de páginas HTML facilitando assim, a gerar páginas HTML no lado servidor de forma dinâmica, permitindo a troca de informações entre o código Java e as página HTML, CSS e javascript. 
* O projeto possue a arquitetura no padão MVC.
* Para os testes unitarios foi utilizado o JUNIT 5.
* Para facilitar o build do projeto, foi utilizado o Docker que através do arquivo dockerfile execulta o deploy da aplicação.

## Executando o projeto

### Build com Docker

Com o docker instalado na máquina, realizar os seguintes comandos:  

* 1º docker pull 85devs/carana
* 2º docker run -itd --name CARANA -p 8080:8080 --restart always 85devs/carana

### Execultar o projeto clonado pelo git

* Para  executar o projeto, após ser clonado o repositótio, é necessário executar o arquivo "CaranaVirusApplication.java", como "Java application".
...
### json
* Dependência usada para realizar requisição para o "viacep", com fim de obter um objeto json com o endereço do cep correspondente.
